      ...
      {CAR_IMAGES.map((src, i) => (
        ...
        >
          ...
          <img
            ...
            style={{
              position: 'absolute',
              bottom: showDesktopImages ? '6%' : '30%',
              left: '50%',
              transform: 'translateX(-50%)',
              width: showDesktopImages ? '96%' : '200%',
              height: showDesktopImages ? '80%' : '130%',
              objectFit: 'contain',
      ...
      <div
        style={{
          ...
          background: isDesktop
            ...
            : 'linear-gradient(to bottom, transparent 55%, rgba(0,0,0,0.55) 72%, #000 95%)',
          pointerEvents: 'none',
        }}
      />
